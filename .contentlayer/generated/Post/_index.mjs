...
import blog__pourquoiFaireAppelAExpressePlomberie_24h_24Mdx from './blog__Pourquoi-faire-appel-a-Expresse-Plomberie-24h-24.mdx.json' assert { type: 'json' }

export const allPosts = [blog__fuiteDEauEnPleineNuitMdx, blog__lesSolutionsPourDeboucherVosCanalisationsMdx, blog__panneDeChauffeEauMdx, blog__pourquoiFaireAppelAExpressePlomberie_24h_24Mdx]
